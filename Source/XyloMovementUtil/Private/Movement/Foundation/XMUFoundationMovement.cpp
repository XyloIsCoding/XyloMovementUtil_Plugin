...
void UXMUFoundationMovement::ResizeCapsule(float NewCapsuleHalfHeight, float NewCapsuleRadius, EXMUCapsuleScalingMode ScalingMode, bool bClientSimulation)
{
	...
	if( CharacterOwner->GetCapsuleComponent()->GetUnscaledCapsuleHalfHeight() == NewCapsuleHalfHeight )
	{
		...
		CharacterOwner->OnEndCrouch( 0.f, 0.f ); //TODO : use callback or return value
		return;
	}
	...
	HalfHeightAdjust = (DefaultCharacter->GetCapsuleComponent()->GetUnscaledCapsuleHalfHeight() - ClampedNewdHalfHeight);
	ScaledHalfHeightAdjust = HalfHeightAdjust * ComponentScale;

	AdjustProxyCapsuleSize();
	CharacterOwner->OnEndCrouch( HalfHeightAdjust, ScaledHalfHeightAdjust );  //TODO : use callback or return value
...
void UXMUFoundationMovement::IncreaseCapsuleHH(float NewCapsuleHalfHeight, EXMUCapsuleScalingMode ScalingMode, bool bClientSimulation)
{
	// Grow to new size.
	check(CharacterOwner->GetCapsuleComponent());
...
void UXMUFoundationMovement::DecreaseCapsuleHH(float NewCapsuleHalfHeight, EXMUCapsuleScalingMode ScalingMode, bool bClientSimulation)
{
